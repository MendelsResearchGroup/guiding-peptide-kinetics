...
printf "${YELLOW}\n---------- [Stretch] ----------${NC}\n"
gmx mdrun -ntmpi 1 -ntomp 16 -nb cpu -pme cpu -update cpu -pin on -v -deffnm md -nsteps 200000 -plumed ../plumed/stretch.dat

printf "\n${CYAN}---------- [Center Protein in Box] ----------${NC}\n"
printf "1\n1\n" | gmx trjconv -s md.tpr -f md.xtc -o md_center.xtc -center -pbc mol

# gmx mdrun -ntmpi 1 -ntomp 16 -nb gpu -pme gpu -pin on -v -deffnm md -nsteps 30000 -plumed ../plumed/plumed.dat -cpi md.cpt
